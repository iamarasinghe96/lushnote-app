      ...
      <div className="px-5 pb-5 space-y-4">
        ...
        {phase === 'idle' && (
          <>
            ...
            <div className="rounded-[var(--r)] bg-red-50 border border-red-300 px-3 py-2.5 flex items-start gap-2 motion-safe:animate-pulse">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-red-500 shrink-0 mt-0.5" aria-hidden>
