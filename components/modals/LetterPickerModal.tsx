...
export default function LetterPickerModal({ open, onSelect, onClose }: LetterPickerModalProps) {
  return (
    <Modal open={open} onClose={onClose} title="Choose letter type" maxWidth="md">
      <div className="px-5 pb-5">
        <p className="text-sm text-[var(--text2)]">Select the type of letter to generate</p>
