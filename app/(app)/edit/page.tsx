...
import { buildTemplatePrompt, formatDateForLetter, calculateAgeFromDOB, autoNumberLines, stripRedundantSectionLabel, autoSessionTime } from '@/lib/utils'
  ...
  return (
    <div className="h-full overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Form — starts at top:0, contentPt pushes first item below the floating bars */}
        <div ref={formScrollRef} className="h-full overflow-y-auto px-4 pb-tabbar min-h-0" style={{ paddingTop: contentPt }}>
